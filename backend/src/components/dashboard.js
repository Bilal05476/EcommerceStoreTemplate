              ...
              <CardBody className="bg-warning">
                <Media className="static-top-widget row">
                  ...
                  <Media body className="col-8">
                    ...
                    <h3 className="mb-0">
                      Rs <CountUp className="counter" end={156659} />
              ...
              <CardBody className="bg-secondary ">
                <Media className="static-top-widget row">
                  ...
                  <Media body className="col-8">
                    ...
                    <h3 className="mb-0">
                      Rs <CountUp className="counter" end={109856} />
                      <small> This Month</small>
                    </h3>
                  </Media>
                </Media>
              ...
              <CardBody className="bg-primary">
                <Media className="static-top-widget row">
                  ...
                  <Media body className="col-8">
                    ...
                    <h3 className="mb-0">
                      <CountUp className="counter" end={11933} />
                      <small> This Month</small>
                    </h3>
                  </Media>
                </Media>
              ...
              <CardBody className="bg-danger ">
                <Media className="static-top-widget row">
                  ...
                  <Media body className="col-8">
                    ...
                    <h3 className="mb-0">
                      Rs <CountUp className="counter" end={4631} />
                      <small> This Month</small>
                    </h3>
                  </Media>
                </Media>
